...
There is a series of 4 videos that describe the pipeline and walk you through this example, they can be found here:
 ...
 - [Introduction to cytotypr](https://www.youtube.com/watch?v=A8eo_4oRvCs)
 - [Reading in and gating data](https://www.youtube.com/watch?v=ToN9yX-gmcU)
 - [Feature engineering](https://www.youtube.com/watch?v=NsgVr2owgwE)
 - [Visualizations](https://www.youtube.com/watch?v=p3-pHWNlPdg)
 
You can find the code for this example on my [github page](https://github.com/aef1004/cytotypr) in the protocol folder labeled "full_example.Rmd"
...
You can install the development version of cytotypr from [GitHub](https://github.com/aef1004/cytotypr) with:
